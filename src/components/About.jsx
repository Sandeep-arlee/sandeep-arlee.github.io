...
export default function About() {
  return (
    <section id="about" className="pt-24 min-h-screen flex items-center justify-center bg-[#000000] text-white px-4">

      <motion.div
        className="backdrop-blur-xl bg-[#1a1a1a]/70 rounded-2xl border border-[#540c3e]/30 p-8 max-w-3xl shadow-xl"
        initial={{ opacity: 0, y: 60 }}
        whileInView={{ opacity: 1, y: 0 }}
        viewport={{ once: true, amount: 0.3 }}
        transition={{ duration: 1 }}
      >
        <h2 className="text-3xl font-bold mb-4 bg-gradient-to-r from-[#540c3e] to-[#8a2be2] text-transparent bg-clip-text">
          About Me
        </h2>
